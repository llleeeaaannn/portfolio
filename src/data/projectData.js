...
const stockleData = {
  ...
  technical: ["A once daily 'Stockle' which is identical for all users who are offered 6 guesses to decipher the ticker.", "A dynamic user interface and game logic which adapts the number of guess squares depending on the ticker of the day.", "Dark and Light Mode alongside a High Contrast Mode for those with visual impairments.", "Statistic tracking stored in the brower's local storage allowing tracking of their scores without necessitating a cumbersome login which could negatively influence user adoption."],
  usage: ["", "", ""],
  todo: [],
  link: '/stockle',
