...
const spotlistData = {
  ...
  "The frontend is built on the React framework and availing of the React Router DOM library to enable routing. The application is styled through vanilla CSS with the use of CSS Modules allowing code seperation, preventing namespace collision alongside improving readability and maintainability. Spotlist's frontend is hosted on Cloudflare Pages with a custom domain and avails of Cloudflare analytics.",
  ...
  "The backend is hosted on an AWS EC2 Instance running Linux and persists through the use of Screen GNU. It is accessed through an AWS API Gateaway.",
